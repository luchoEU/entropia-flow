...
import { Inventory, ViewState, Status, STATUS_TYPE_MONITORING_OFF, STATUS_TYPE_LOG, STATUS_TYPE_TIME, TimeLeft } from "../common/state"
...
const STATE_MONITORING_OFF: ViewState = {
    status: {
        type: STATUS_TYPE_MONITORING_OFF
    }
}
