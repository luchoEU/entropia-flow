import { StreamPreRenderData, StreamSavedLayout, StreamSavedLayoutSet } from "../../../stream/data"
...
export const getStreamData = (state: any): StreamPreRenderData | undefined => getStreamOut(state).data
