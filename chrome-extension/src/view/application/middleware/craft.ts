...
const requests = ({ api }) => ({ dispatch, getState }) => next => async (action) => {
    ...
    switch (action.type) {
        ...
        case SET_CRAFT_MATERIALS_EXPANDED:
