...
import { SET_BLUEPRINT_PARTIAL_WEB_DATA, SET_CRAFT_STATE } from "../actions/craft"
import { ADD_AVAILABLE, CANCEL_BY_STORE_ITEM_NAME_EDITING, CANCEL_BY_STORE_STARED_ITEM_NAME_EDITING, CONFIRM_BY_STORE_ITEM_NAME_EDITING, CONFIRM_BY_STORE_STARED_ITEM_NAME_EDITING, HIDE_BY_CONTAINER, HIDE_BY_NAME, HIDE_BY_VALUE, LOAD_TRADING_ITEM_DATA, loadInventoryState, loadTradingItemData, REMOVE_AVAILABLE, SET_AUCTION_EXPANDED, SET_AVAILABLE_EXPANDED, SET_BLUEPRINTS_EXPANDED, SET_BLUEPRINTS_FILTER, SET_BY_STORE_ALL_ITEMS_EXPANDED, SET_BY_STORE_CRAFT_FILTER, SET_BY_STORE_CRAFT_ITEM_EXPANDED, SET_BY_STORE_EXPANDED, SET_BY_STORE_FILTER, SET_BY_STORE_ITEM_EXPANDED, SET_BY_STORE_ITEM_NAME, SET_BY_STORE_ITEM_STARED, SET_BY_STORE_STARED_ALL_ITEMS_EXPANDED, SET_BY_STORE_STARED_EXPANDED, SET_BY_STORE_STARED_FILTER, SET_BY_STORE_STARED_ITEM_EXPANDED, SET_BY_STORE_STARED_ITEM_NAME, SET_BY_STORE_STARED_ITEM_STARED, SET_HIDDEN_EXPANDED, SET_HIDDEN_FILTER, SET_VISIBLE_EXPANDED, SET_VISIBLE_FILTER, SHOW_ALL, SHOW_BY_CONTAINER, SHOW_BY_NAME, SHOW_BY_VALUE, SHOW_TRADING_ITEM_DATA, SORT_AUCTION_BY, SORT_AVAILABLE_BY, SORT_BY_STORE_BY, SORT_BY_STORE_CRAFT_BY, SORT_BY_STORE_STARED_BY, SORT_HIDDEN_BY, SORT_TRADE_BLUEPRINTS_BY, SORT_VISIBLE_BY, START_BY_STORE_ITEM_NAME_EDITING, START_BY_STORE_STARED_ITEM_NAME_EDITING } from "../actions/inventory"
...
const requests = ({ api }) => ({ dispatch, getState }) => next => async (action) => {
    ...
    switch (action.type) {
        ...
        case SET_BLUEPRINT_PARTIAL_WEB_DATA: {
            ...
            dispatch(loadTradingItemData(craftState))
            break
        }
    }
}
