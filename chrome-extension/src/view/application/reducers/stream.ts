import { ADD_STREAM_LAYOUT, CLEAR_STREAM_LAYOUT_ALIAS, CLONE_STREAM_LAYOUT, EMPTY_TRASH_LAYOUTS, IMPORT_STREAM_LAYOUT_FROM_FILE, REMOVE_STREAM_LAYOUT, RESTORE_STREAM_LAYOUT, SET_STREAM_ADVANCED, SET_STREAM_AUTHOR, SET_STREAM_BACKGROUND_SELECTED, SET_STREAM_CSS_TEMPLATE, SET_STREAM_ENABLED, SET_STREAM_FORMULA_JAVASCRIPT, SET_STREAM_HTML_TEMPLATE, SET_STREAM_NAME, SET_STREAM_STARED, SET_STREAM_STATE, SET_STREAM_TEMPORAL_VARIABLES, SET_STREAM_USER_PARTIAL, SET_STREAM_VARIABLES, ADD_STREAM_USER_IMAGE, REMOVE_STREAM_USER, SET_STREAM_SHOWING_LAYOUT_ID, SET_STREAM_USED_LAYOUTS, ADD_STREAM_USER_PARAMETER, SET_STREAM_DATA } from "../actions/stream"
