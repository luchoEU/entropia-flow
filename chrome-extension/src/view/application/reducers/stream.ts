import { SET_STREAM_BACKGROUND_EXPANDED, SET_STREAM_BACKGROUND_SELECTED, SET_STREAM_CONTAINER_STYLE, SET_STREAM_DATA, SET_STREAM_EDITING, SET_STREAM_ENABLED, SET_STREAM_STATE, SET_STREAM_TEMPLATE, SET_STREAM_VARIABLES } from "../actions/stream"
import { initialState, reduceSetStreamBackgroundExpanded, reduceSetStreamBackgroundSelected, reduceSetStreamContainerStyle, reduceSetStreamData, reduceSetStreamEditing, reduceSetStreamEnabled, reduceSetStreamState, reduceSetStreamTemplate, reduceSetStreamVariables } from "../helpers/stream"
