import { REFINED_BUY_MATERIAL, REFINED_MARKUP_CHANGED, REFINED_MATERIAL_CHANGED, REFINED_ORDER_MATERIAL, REFINED_SELL, REFINED_VALUE_CHANGED, SET_REFINED_EXPANDED, SET_REFINED_STATE } from "../actions/refined"
import { initialState, refinedBuyMaterial, refinedMarkupChanged, refinedMaterialChanged, refinedOrderMaterial, refinedSell, refinedValueChanged, setRefinedExpanded, setState } from "../helpers/refined"
...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case REFINED_ORDER_MATERIAL: return refinedOrderMaterial(state, action.payload.materiak, action.payload.ttValue, action.payload.markup)
