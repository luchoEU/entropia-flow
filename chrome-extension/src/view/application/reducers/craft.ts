import { ADD_BLUEPRINT, ADD_BLUEPRINT_DATA, BUY_BUDGET_PAGE_MATERIAL, BUY_BUDGET_PAGE_MATERIAL_CLEAR, BUY_BUDGET_PAGE_MATERIAL_DONE, CHANGE_BUDGET_PAGE_BUY_COST, CHANGE_BUDGET_PAGE_BUY_FEE, CLEAR_CRAFT_SESSION, DONE_CRAFT_SESSION, END_BUDGET_PAGE_LOADING, END_CRAFT_SESSION, ERROR_BUDGET_PAGE_LOADING, ERROR_CRAFT_SESSION, MOVE_ALL_BUDGET_PAGE_MATERIAL, READY_CRAFT_SESSION, REMOVE_BLUEPRINT, SAVE_CRAFT_SESSION, SET_ACTIVE_BLUEPRINTS_EXPANDED, SET_BLUEPRINT_EXPANDED, SET_BLUEPRINT_QUANTITY, SET_BUDGET_PAGE_INFO, SET_BUDGET_PAGE_LOADING_STAGE, SET_CRAFT_MATERIALS_EXPANDED, SET_CRAFT_SAVE_STAGE, SET_CRAFT_STATE, SET_NEW_CRAFT_SESSION_DIFF, SORT_BLUEPRINTS_BY, START_BUDGET_PAGE_LOADING, START_CRAFT_SESSION } from "../actions/craft"
import { addBlueprint, addBlueprintData, buyBudgetMaterial, buyBudgetMaterialClear, buyBudgetMaterialDone, changeBudgetBuyCost, changeBudgetBuyFee, clearCraftSession, doneCraftSession, endBudgetLoading, endCraftSession, errorBudgetLoading, errorCraftSession, initialState, readyCraftSession, removeBlueprint, saveCraftSession, setActiveBlueprintsExpanded, setBlueprintExpanded, setBlueprintQuantity, setBudgetInfo, setBudgetState, setCraftMaterialsExpanded, setCraftSaveStage, setCraftSessionDiff, setState, sortBlueprintsByPart, startBudgetLoading, startCraftSession } from "../helpers/craft"
...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case SET_CRAFT_MATERIALS_EXPANDED: return setCraftMaterialsExpanded(state, action.payload.expanded)
        ...
        case BUY_BUDGET_PAGE_MATERIAL_DONE: return buyBudgetMaterialDone(state, action.payload.name, action.payload.materialName, action.payload.quantity)
        ...
        case CHANGE_BUDGET_PAGE_BUY_FEE: return changeBudgetBuyFee(state, action.payload.name, action.payload.materialName, action.payload.withFee)
