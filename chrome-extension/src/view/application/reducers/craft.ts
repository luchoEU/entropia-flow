import { ADD_BLUEPRINT, ADD_BLUEPRINT_DATA, BUY_BUDGET_PAGE_MATERIAL, BUY_BUDGET_PAGE_MATERIAL_CLEAR, BUY_BUDGET_PAGE_MATERIAL_DONE, CHANGE_BUDGET_PAGE_BUY_COST, CHANGE_BUDGET_PAGE_BUY_FEE, CLEAR_CRAFT_SESSION, DONE_CRAFT_SESSION, END_BUDGET_PAGE_LOADING, END_CRAFT_SESSION, ERROR_BUDGET_PAGE_LOADING, ERROR_CRAFT_SESSION, MOVE_ALL_BUDGET_PAGE_MATERIAL, READY_CRAFT_SESSION, REMOVE_BLUEPRINT, SAVE_CRAFT_SESSION, SET_ACTIVE_BLUEPRINTS_EXPANDED, SET_ACTIVE_BLUEPRINTS_FILTER, SET_BLUEPRINT_EXPANDED, SET_BLUEPRINT_QUANTITY, SET_BUDGET_PAGE_INFO, SET_BUDGET_PAGE_LOADING_STAGE, SET_CRAFT_SAVE_STAGE, SET_CRAFT_STATE, SET_NEW_CRAFT_SESSION_DIFF, SHOW_BLUEPRINT_MATERIAL_DATA, SORT_BLUEPRINTS_BY, START_BUDGET_PAGE_LOADING, START_CRAFT_SESSION } from "../actions/craft"
import { initialState, reduceAddBlueprint, reduceAddBlueprintData, reduceBuyBudgetMaterial, reduceBuyBudgetMaterialClear, reduceBuyBudgetMaterialDone, reduceChangeBudgetBuyCost, reduceChangeBudgetBuyFee, reduceClearCraftSession, reduceDoneCraftSession, reduceEndBudgetLoading, reduceEndCraftSession, reduceErrorBudgetLoading, reduceErrorCraftSession, reduceReadyCraftSession, reduceRemoveBlueprint, reduceSaveCraftSession, reduceSetActiveBlueprintsExpanded, reduceSetActiveBlueprintsFilter, reduceSetBlueprintExpanded, reduceSetBlueprintQuantity, reduceSetBudgetInfo, reduceSetBudgetState, reduceSetCraftSaveStage, reduceSetCraftSessionDiff, reduceSetState, reduceShowBlueprintMaterialData, reduceSortBlueprintsByPart, reduceStartBudgetLoading, reduceStartCraftSession } from "../helpers/craft"
...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case SET_ACTIVE_BLUEPRINTS_EXPANDED: return reduceSetActiveBlueprintsExpanded(state, action.payload.expanded)
        case SET_ACTIVE_BLUEPRINTS_FILTER: return reduceSetActiveBlueprintsFilter(state, action.payload.filter)
