...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case SET_BLUEPRINT_LIST: return reduceSetBlueprintList(state, action.payload.list)
