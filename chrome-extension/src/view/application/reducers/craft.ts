...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case SET_ACTIVE_BLUEPRINTS_FILTER: return reduceSetBlueprintFilter(state, action.payload.filter)
