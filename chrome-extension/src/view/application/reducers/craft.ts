...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case ADD_BLUEPRINT_LOADING: return reduceAddBlueprintLoading(state, action.payload.name)
