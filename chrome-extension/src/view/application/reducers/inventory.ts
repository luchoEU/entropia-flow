...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case SORT_TRADE_FAVORITE_BLUEPRINTS_BY: return reduceSortTradeFavoriteBlueprintsBy(state, action.payload.part)
        case SORT_TRADE_OWNED_BLUEPRINTS_BY: return reduceSortTradeOwnedBlueprintsBy(state, action.payload.part)
        case SORT_TRADE_OTHER_BLUEPRINTS_BY: return reduceSortTradeOtherBlueprintsBy(state, action.payload.part)
