...
export default (state = initialState, action) => {
    switch (action.type) {
        case ADD_PENDING_CHANGE: return addPendingChange(state, action.payload.operationType, action.payload.date, action.payload.material, action.payload.parameters, action.payload.doneParameters)
