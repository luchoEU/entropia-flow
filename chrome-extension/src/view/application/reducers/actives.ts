...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case ADD_ACTIVE: return addActive(state, action.payload.row, action.payload.title, action.payload.quantity, action.payload.opening, action.payload.buyout, action.payload.buyoutFee)
