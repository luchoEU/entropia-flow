...
export default (state = initialState, action) => {
    switch (action.type) {
        ...
        case ADD_SALE: return addActive(state, action.payload.row, action.payload.type, action.payload.quantity, action.payload.opening, action.payload.buyout, action.payload.buyoutFee)
