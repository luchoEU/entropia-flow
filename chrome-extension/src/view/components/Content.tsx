...
import { ABOUT_PAGE, BUDGET_PAGE, CONNECTION_PAGE, CRAFT_PAGE, GAME_LOG_PAGE, GAME_SPLIT_PAGE, INVENTORY_PAGE, MONITOR_PAGE, REFINED_PAGE, SETTING_PAGE, STREAM_PAGE, TRADE_PAGE } from '../application/actions/menu'
