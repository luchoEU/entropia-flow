...
const MSG_NAME_CONTENT_SET_MONITORING = 'RefreshContent'
const MSG_NAME_REFRESH_ITEMS_AJAX = 'RefreshItemsAjax'
const MSG_NAME_REFRESH_WAKE_UP = 'RefreshWakeUp'
const MSG_NAME_CONTENT_SET_SLEEP_MODE = 'RefreshSetSleepMode'
const MSG_NAME_NEW_INVENTORY = 'NewInventory'
const MSG_NAME_MONITORING_CHANGED = 'MonitoringChanged'
...
const MSG_NAME_REQUEST_CHANGE_MONITORING = 'RequestChangeMonitoring'
const MSG_NAME_SET_SHOWING_LAYOUT_ID = 'SetShowingLayoutId'
const MSG_NAME_STORAGE_CHANGED = 'StorageChanged'
...
const STORAGE_VIEW_HISTORY = 'history'
